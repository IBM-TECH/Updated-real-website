...
timeline:
  - year: "2026"
    ...
    organization: NEON.LAB Studios
    description: Heading the art team on a flagship cyberpunk RPG with a 24-person studio.
    type: work
  - year: "2024"
    title: Solo Exhibition — 'AFTER LIGHT'
    organization: Möbius Gallery, Berlin
    description: First solo show of large-format AI-assisted 3D paintings. Sold out
      in 9 days.
    type: exhibition
  - year: "2023"
    title: Senior Concept Artist
    organization: Heliox Pictures
    description: Worked on 3 unannounced feature films and 1 streaming series.
    type: work
  - year: "2022"
    title: Behance Featured Artist of the Year
    organization: Adobe
    description: Top 25 globally across 24 million artists.
    type: award
  - year: "2020"
    title: Concept Artist
    organization: Frostbyte Games
    description: Environment & creature design for two AAA titles.
    type: work
  - year: "2018"
    title: BFA, Digital Media & Visual Effects
    organization: ArtCenter College of Design
    description: Graduated with honors. Thesis on procedural environment storytelling.
    type: education
---
